...
def store_interaction(conversation_id, user_input, response, rating):
    ...
    sql = "INSERT INTO interacciones (conversation_id, user_input, response, rating) VALUES (%s, %s, %s, %s)"
    val = (conversation_id, user_input, response, rating)
...
# Generar un identificador único para la conversación
...
if user_input:
    ...
    if rating:
        store_interaction(conversation_id, user_input, response, rating)
