...
model.add(Dense(64, name="hidden_layer3", activation="relu"))
model.add(Dense(64, name="hidden_layer4", activation="relu"))
model.add(Dense(64, name="hidden_layer5", activation="relu"))
model.add(Dense(64, name="hidden_layer6", activation="relu"))
model.add(Dense(64, name="hidden_layer7", activation="relu"))
model.add(Dense(64, name="hidden_layer8", activation="relu"))
model.add(Dense(64, name="hidden_layer9", activation="relu"))
model.add(Dense(64, name="hidden_layer10", activation="relu"))
model.add(Dropout(0.5, name="hidden_layer11"))
